...
File issues at https://github.com/davidsolheim/futuraterm/issues with steps to reproduce and your macOS version. `mise run logs --last 30m` is a good way to grab relevant log output.
