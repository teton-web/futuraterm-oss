...
FORK_REPO="teton-web/futuraterm-ghosttykit"
ZMX_REPO="teton-web/futuraterm-zmx"
XCFRAMEWORK_DIR="GhosttyKit.xcframework"
# The pinned teton-web/futuraterm-ghosttykit release supplying BOTH GhosttyKit
...
# teton-web/futuraterm-zmx, mirroring GhosttyKit — never compiled locally (zig).
...
if $need_zmx; then
  # Prebuilt universal (arm64+x86_64) zmx binary from teton-web/futuraterm-zmx.
