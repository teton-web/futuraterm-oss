...
VERSION="$(read_marketing_version "$PROJECT_ROOT/VERSION")"
...
APP="$DERIVED_DATA/Build/Products/Debug/FuturaTermDebug.app"
...
# registered under the same `com.davidsolheim.futuraterm.debug` ID — this checkout, every
...
#
# Still LaunchServices rather than exec'ing Contents/MacOS/FuturaTerm directly:
