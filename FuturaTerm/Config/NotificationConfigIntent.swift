...
/// telling this user that macOS is dropping FuturaTerm's notifications? Everyone
/// who has never granted the permission is technically affected — FuturaTerm posts
