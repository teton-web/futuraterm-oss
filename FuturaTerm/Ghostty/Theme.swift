...
enum FuturaTermTheme {
    ...
    /// Palette indices follow the ANSI convention: 1 = red, 2 = green, 3 = yellow.
    @MainActor
    ...
    static var nsSearchTick: NSColor {
        nsColor(SearchHighlightColors.matchBackground(inConfigText: FuturaTermConfig.userGhosttyConfigText()))
    }

    @MainActor
    static var nsSearchTickSelected: NSColor {
        nsColor(SearchHighlightColors.selectedBackground(inConfigText: FuturaTermConfig.userGhosttyConfigText()))
    }
