...
/// (`~/.config/futuraterm/projects/*.yaml`) — the one place a project's layout is
...
/// Files and the runtime project list are deliberately decoupled: FuturaTerm
...
extension ProjectFile {
    ...
    static let schemaModeline =
        "# yaml-language-server: $schema=https://futuraterm.com/schema/project.json"
