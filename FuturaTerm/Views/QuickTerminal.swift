...
final class QuickTerminalService: NSObject {
    ...
    /// Captured so we can re-activate it on hide if FuturaTerm somehow took over —
    /// without this, dismissing the panel would leave focus on FuturaTerm even
    ...
    override private init() {
        ...
        NotificationCenter.default.addObserver(
            ...
            name: .futuraTermConfigDidChange,
            object: nil
        )
        registerHotKey()
    }
    ...
    private func show() {
        ...
        // without activating FuturaTerm — the same trick Spotlight and Ghostty's
    ...
    private func hide() {
        ...
        panel = nil
        isVisible = false
        // Belt-and-suspenders: if FuturaTerm somehow ended up frontmost while the
        ...
        // active before. Skips when FuturaTerm wasn't frontmost to begin with —
