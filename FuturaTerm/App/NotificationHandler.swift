...
final class NotificationHandler: NSObject, UNUserNotificationCenterDelegate {
    ...
    /// the other half — an install that granted permission back when FuturaTerm
    ...
    /// Every identifier is `futuraterm-<paneID>-<unique>`, which makes a pane's
