...
final class AppState {
    ...
    func viewDesktop(
        ...
        let moonlight = moonlightAvailable ?? Self.macMoonlightAvailable()
    ...
    /// Moonlight.app via Launch Services bundle id, then /Applications.
    static func moonlightAppURL(
        ...
        let path = "/Applications/Moonlight.app"
        return appExists(path) ? URL(fileURLWithPath: path) : nil
    }
    ...
    static func macMoonlightAvailable(
        ...
        moonlightAppURL(bundleURL: bundleURL, appExists: appExists) != nil
    }
    ...
    static func performDesktopLaunch(_ action: DesktopLaunchAction) async -> Bool {
        ...
        case let .moonlight(arguments):
            guard let app = moonlightAppURL() else { return false }
