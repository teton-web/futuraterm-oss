...
/// from #209, where `ctrl+h` moves FuturaTerm panes at a shell prompt but reaches
/// nvim so it can move its own splits (and call `futuraterm pane focus
...
/// is the only one that can be *right* rather than merely defensible — FuturaTerm
