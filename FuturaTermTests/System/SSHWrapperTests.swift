...
struct SSHWrapperTests {
    ...
    func entry_name_matches_remote_terminfo() {
        ...
        // ssh is user-typed (SSHWrapper) or FuturaTerm-owned (RemoteTerminfo).
    ...
    func bundled_db_resolves_beside_the_binary() {
        let db = SSHWrapper.bundledTerminfoDirectory(
            executablePath: "/Applications/FuturaTerm.app/Contents/Resources/bin/futuraterm",
            exists: { $0 == "/Applications/FuturaTerm.app/Contents/Resources/terminfo/78/xterm-ghostty" }
        )
        #expect(db == "/Applications/FuturaTerm.app/Contents/Resources/terminfo")
    }
    ...
    func bundled_db_requires_the_hashed_entry_itself() {
        ...
        let db = SSHWrapper.bundledTerminfoDirectory(
            executablePath: "/Applications/FuturaTerm.app/Contents/Resources/bin/futuraterm",
            exists: { $0 == "/Applications/FuturaTerm.app/Contents/Resources/terminfo" }
        )
        #expect(db == nil)
    }
