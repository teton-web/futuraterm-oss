...
const SITE_URL = "https://futuraterm.com";
  ...
  for (const page of pages) {
    ...
    const title =
      page.meta.slug === "index"
        ? "FuturaTerm Docs"
        : `${page.meta.title} — FuturaTerm Docs`;
    const description =
      page.meta.description ||
      "Install, configure, and drive FuturaTerm — a native macOS terminal built on libghostty.";
      ...
      "@graph": [
        {
          ...
          url: canonical,
          inLanguage: "en",
          isPartOf: { "@type": "WebSite", name: "FuturaTerm", url: SITE_URL + "/" },
          about: { "@type": "SoftwareApplication", name: "FuturaTerm" },
        },
        {
          "@type": "BreadcrumbList",
          itemListElement: [
